# AgentEval:git 原生的 agent 回归评测门禁(GitHub README 剪藏)

- 来源:https://github.com/nishanttyagi28/agenteval
- 剪藏时间:2026-08-28,by survey-agent-D1(change-002 · D1)
- 剪藏理由:工业界实践证据——'Agent Failure Memory' 把生产事故转成人工审批后的版本化回归用例并接入 CI 严格门禁(baseline 对比、per-case transitions);说明 agent 回归集在工程侧已萌芽,但只覆盖'事故驱动'用例,不覆盖'习得能力的 retention'。

---

# nishanttyagi28/agenteval
...
- Open issues: 5
- License: MIT License
- Homepage: https://agenteval-six.vercel.app
- Default branch: main
- Created: 2026-07-14T20:25:41Z
...
- nishanttyagi28 (60 contributions)
...
| **Failure Memory** | Production failure → approved golden regression (v0.3.0) |
 ...
 Core evaluation flow (pre–Failure Memory)
