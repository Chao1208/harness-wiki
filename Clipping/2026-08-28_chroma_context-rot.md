# Context Rot: How Increasing Input Tokens Impacts LLM Performance(Chroma 技术报告剪藏)

- 来源:https://research.trychroma.com/context-rot
- 作者:Kelly Hong, Anton Troynikov, Jeff Huber(Chroma)
- 报告时间:2025-07;剪藏时间:2026-08-28,by survey-agent-D1(change-002 · D1)
- 剪藏理由:'context rot' 一词的出处;证明输入长度增长本身即导致模型行为非均匀退化(18 个模型,NIAH 扩展/LongMemEval/重复词三任务)。D1 中用作'context 层退化'与'harness 更新回归'的概念区分参照。
